  ...
  Container textfield(List<bool> havecard, List<Widget> cards) {
    ...
    var searchbutton = GestureDetector(
      child: Container(
        ...
        height: h * 30,
        child: Image.asset(
          "assets/png_picture/addcardbutton1.png",
          fit: BoxFit.cover,
        ),
      ),
      onTap: () {},
  ...
  addbubule() {
    var arrowbutton = GestureDetector(
      child: Container(
        width: w * 34,
        height: h * 32,
        child: Image.asset("assets/png_picture/arrowbutton.png"),
      ),
      onTap: () {},
    );
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          image: DecorationImage(
              image: AssetImage("assets/png_picture/addbuble.png"))),
      child: Stack(
        children: [
          Positioned(
              top: h * 27,
    ...
    return Container(
        ...
        child: (Stack(
          ...
          children: [
            ...
            Positioned(left: w * 32, top: h * 126, child: addbubule()),
            Positioned(
                left: w * 20,
                top: h * 210,
